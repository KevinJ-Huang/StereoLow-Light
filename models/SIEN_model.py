...
class SIEN_Model(BaseModel):
    ...
    def optimize_parameters(self, step):
        ...
        loss_level4 = self.level_loss(LR_left,HR_left,LR_right,HR_right,SR_left,SR_right,M_right_to_left,M_left_to_right,V_left,V_right,4)
        ...
        l_total = loss_SR + 0.4*loss_level4
        ...
        # self.log_dict['l_lv2'] = loss_level2.item()
