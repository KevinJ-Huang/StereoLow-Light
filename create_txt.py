...
def main():
    ...
    for img in imgs:
        ...
        groups += os.path.join(inputdir, 'right', img) + '|'
        groups += os.path.join(targetdir, 'right', img)

        with open(os.path.join(outputdir, 'groups_test_small.txt'), 'a') as f:
                f.write(groups + '\n')


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default='/gdata/huangjie/Stereo/Midllery_small/test/low', metavar='PATH', help='root dir to save low resolution images')
    parser.add_argument('--target', type=str, default='/gdata/huangjie/Stereo/Midllery_small/test/gt', metavar='PATH', help='root dir to save high resolution images')
    parser.add_argument('--output', type=str, default='/ghome/huangjie/STEN_Mid/data/', metavar='PATH', help='output dir to save group txt files')
